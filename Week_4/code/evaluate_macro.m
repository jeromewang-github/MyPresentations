...
retrieved_relevant_pairs = (Rel & Ret);%the retrived and relevat train documents for each test document
...
for j = 1:numTest
    ...
    if retrieved_num
        precisions(j) = retrieved_relevant_num / retrieved_num;%the retriving accuracy
    else
        precisions(j) = 1;
    end
    if relevant_num
